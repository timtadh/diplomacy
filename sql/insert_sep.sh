...
mysql $DB_NAME $CONN_STR -e "create  database if not exists seperation;"
...
mysql $DB_NAME $CONN_STR -e "CREATE TABLE IF NOT EXISTS sep_" + $num + \
    " (a int(11), b int(11), sep int(11), CONSTRAINT pk_ab PRIMARY KEY (a, b));"
